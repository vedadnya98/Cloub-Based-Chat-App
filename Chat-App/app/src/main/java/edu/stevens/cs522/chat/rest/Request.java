...
public abstract class Request implements Parcelable {
    ...
    protected Request(long id, UUID clientID) {
        ...
        this.appID = clientID;
        this.latitude = Double.parseDouble(String.valueOf(R.string.latitude));
        this.longitude = Double.parseDouble(String.valueOf(R.string.longitude));
    }
    ...
    public Map<String,String> getRequestHeaders() {
        ...
        headers.put(LONGITUDE_HEADER, Double.toString(R.string.longitude));
        headers.put(LATITUDE_HEADER, Double.toString(R.string.latitude));
        return headers;
    }
